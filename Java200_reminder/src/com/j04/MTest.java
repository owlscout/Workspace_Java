...
public class MTest {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// array : 같은 타임의 여러개의 값을 효과적으로 관리하기 위한 객체 	/ 타입 고정				/ 크기 고정
		 ...
		 * o	x		k:x v:o	중복	 
		 * 
		 * map 은 key를 통해서 value를 가져와야한다 entry를 사용하면 따로가져올수있다
		 */
		
		// map 을 반복해서 가지고 와서, 
		// age가 10인 사람의 key와 value를 각각 출력하는데,
		// khy를 출력하고 /value가 가지고 있는 age만 출력하자.
		...
		// Iterator : 컬렉션 내부의 값를 읽어오는 표준화된 방법 
